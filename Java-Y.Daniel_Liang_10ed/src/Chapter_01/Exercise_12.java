...
*/
 ...
 public class Exercise_11 {
 	public static void main(String[] args) {
 		...
 		int currentPopulation = 312,032,486;

 		double birthRate = 7.0, deathRate = 13.0, inmigrantionRate = 45.0;
    
        double secondsPerYear = (60 * 60 * 24 * 365);

        double growthPerYear = (birthRate + deathRate - inmigrantionRate) / oneBirthEverySevenSeconds);
    
        for (int i = 1; i <= 5; i++) {
            currentPopulation += growthPerYear;
            System.out.println("Population of Year " + i + " = " + (int)currentPopulation);
        }
 	}
 }
